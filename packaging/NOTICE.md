...
This inventory is included in Windows packages as `THIRD-PARTY-NOTICES.md`. Review the upstream licenses and notices when changing dependencies or distributing different binaries. This inventory does not assign a license to Rip's own source code.
